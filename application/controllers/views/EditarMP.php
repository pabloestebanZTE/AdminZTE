          ...
          <div class="wrapper tabs">
              ...
              echo "<div class='wrapperWheel'>";
                echo "<div class='mainWheel'>";
                  echo "<a href='#wheel1' class='wheel-button nw'>";
                    echo "<span><img src='/assets/images/edit.png' /></span>";
                  echo "</a>";
            ...
            if($_SESSION['permissions'][6] == 1){
              ...
              echo "<div class='tab-content' id='tab".$p."'>";
                ...
                echo "<input type='submit' value='Actualizar M.P.' disabled='disabled' id='btnSubmit".$p."' name='btnSubmit".$p."' class='btn btn-success'  onclick = \"this.form.action = '/index.php/Mantenimientos/updateMP' \">";
                  echo "<br><br><br>";
