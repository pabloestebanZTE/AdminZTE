					...
					<div class="slider">
					  	<div class="rslides_container">
							<ul class="rslides" id="slider">
								<li><img src="/assets/images/imagenRotativa4.png" alt=""></li>
								<li><img src="/assets/images/imagenRotativa3.png" alt=""></li>
								<li><img src="/assets/images/imagenRotativa5.png" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<article id="content2">
				<div class="wrapper row">
					...
					<div class="wrap-col">
						<h4>Síguenos</h4>
						<ul id="icons">
							<li><a href="#"><img src="/assets/images/icon1.jpg" alt="">Facebook</a></li>
							<li><a href="#"><img src="/assets/images/icon2.jpg" alt="">Twitter</a></li>
							<li><a href="#"><img src="/assets/images/icon3.jpg" alt="">LinkedIn</a></li>
							<li><a href="#"><img src="/assets/images/icon4.jpg" alt="">Delicious</a></li>
						</ul>
					</div>
					</section>
					<section class="col-1-4">
