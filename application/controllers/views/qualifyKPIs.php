                      ...
                      if ($dates[$dates['years'][$p]['Q_ANO']][$i] != NULL){
                        echo "<div class='tab-content' id='tab".$p.$i."'>";
                          ...
                          echo "<form method='post' name='formActualizar'>";
                            echo "<input type='submit' value='Calificar' disabled='disabled' id='btnSubmit".$p.$i."' name='btnSubmit".$p.$i."' class='btn btn-success'  onclick = \"this.form.action = '/index.php/KPI/updateKPI' \"><br><br>";
