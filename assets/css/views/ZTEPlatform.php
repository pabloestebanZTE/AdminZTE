                ...
                echo "<br><br><br><br><div class='wrapperWheel'>";
                  echo "<div class='mainWheel'>";
                    ...
                    echo "<ul id='wheel'  data-angle='all'>";
                      echo "<li class='item'><a href='/index.php/KPI/KPIPrincial'><img src='/assets/images/KPI.png' /></a></li>";
                      echo "<li class='item'><a href='/index.php/Ticket/TicketPrincipal'><img src='/assets/images/ticket2.png' /></a></li>";
                      echo "<li class='item'><a href=''#home'><img src='/assets/images/process.png' /></a></li>";
                      echo "<li class='item'><a href=''#home'><img src='/assets/images/quality.png' /></a></li>";
                    echo "</ul>";
                  echo "</div>";
                echo "</div>";
