                ...
                echo "<div class='wrapperWheel'>";
                  echo "<div class='mainWheel'>";
                    echo "<a href='#wheel1' class='wheel-button ne'>";
                      echo "<span><img src='/assets/images/home.png' /></span>";
                    echo "</a>";
                    echo "<ul id='wheel1'  data-angle='all'>";
                      echo "<li class='item'><a href='/index.php/ZTEPlatform/platformZTE'><img src='/assets/images/return.png' /></a></li>";
                    echo "</ul>";
                    echo "<br><br><br><br>";
                    ...
                    echo "<ul id='wheel'  data-angle='all'>";
                      echo "<li class='item'><a href='#'><img src='/assets/images/correctivos.png' /></a></li>";
                      echo "<li class='item'><a href='/index.php/Ticket/OtherTicketsPrincipal'><img src='/assets/images/otros.png' /></a></li>";
                      echo "<li class='item'><a href='/index.php/Mantenimientos/preventivosPrincipal'><img src='/assets/images/preventivos.png' /></a></li>";
                    echo "</ul>";
                  echo "</div>";
                echo "</div>";
