              ...
              echo "<div class='wrapperWheel'>";
                echo "<div class='mainWheel'>";
                  echo "<a href='#wheel1' class='wheel-button nw'>";
                    echo "<span><img src='/assets/images/plus.ico' /></span>";
                  echo "</a>";
                  echo "<ul id='wheel1'  data-angle='all'>";
                    echo "<li class='item'><a href='/index.php/Ticket/OtherTicketsPrincipal'><img src='/assets/images/return.png' /></a></li>";
                  echo "</ul>";
                echo "</div>";
              echo "</div>";
              if ($msj != ""){
                  ...
                  echo "<h2 class='under'>Creación de Tickets : Otros</h2>";
                    ...
                    echo "<div class='form-style-5'>";
                      echo "<form  name='formulario' id='formulario' method='post' accept-charset='utf-8'>";
                        ...
                        echo "<input type='submit' value='Crear Ticket' class='btn btn-success' onclick =\"this.form.action = '/index.php/Ticket/createOtherTicket'\" >";
                      echo "</form>";
                    echo "</div>";
                  echo "</div>";
                echo "</div>";
